...
class ClassroomCameraController {
    constructor(camera, characterSystem, controls) {
        ...
        // Animation state - will be initialized when THREE is available
...
// Global export for browser (ES6 export removed for script tag loading)
